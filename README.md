...
### Функции, реализованные в рамках работы над ПР6-ПР7 (19.10-28.11.2020):
...
7. Проведен рефакторинг кода с использованием парадигмы ООП: написаны классы карточек (Card) и валидации форм (FormValidator) 
8. Код JS разделен на модули 
...
### Изменения внесенные в код в процессе работы над ПР6-ПР7 и после итераций (26.10-28.11.2020):
